...
namespace OMS.Infrastructure.Persistence.Migrations
{
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObjectRelationships", x => new { x.ObjectId, x.RelatedObjectId });
                    table.ForeignKey(
                        name: "FK_ObjectRelationships_Objects",
                        column: x => x.ObjectId,
                        principalTable: "Objects",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ObjectRelationships_Objects1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObjectRelationships_RelatedObjectId",
